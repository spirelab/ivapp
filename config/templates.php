...
return [
    ...
    'about-us' => [
        'field_name' => [
            ...
            'short_description' => 'textarea',
            'image' => 'file',
            'about_image_two' => 'file',
            'about_image_three' => 'file'
        ],
        'validation' => [
            'title.*' => 'required|max:100',
            ...
            'short_description.*' => 'required|max:2000',
            'image.*' => 'nullable|max:3072|image|mimes:jpg,jpeg,png',
            'about_image_two.*' => 'nullable|max:3072|image|mimes:jpg,jpeg,png',
            'about_image_three.*' => 'nullable|max:3072|image|mimes:jpg,jpeg,png',
        ]
    ],
    'investment' => [
        'field_name' => [
    ...
    'message' => [
        ...
        'image_two' => 'This field must be image.',
        'about_image_two' => 'This field must be image.',
        'about_image_three' => 'This field must be image.',
