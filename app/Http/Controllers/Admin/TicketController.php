...
class TicketController extends Controller
{
    ...
    public function ticketReplySend(Request $request, $id)
    {
        ...
        if ($request->replayTicket == 1) {
            ...
            $this->adminFirebasePushNotification('ADMIN_NOTIFY_OWN_SUPPORT_REPLY', $msg, route('admin.ticket.view',$ticket->id));
            $this->userFirebasePushNotification($ticket->user, 'USER_NOTIFY_ADMIN_TICKET_REPLY', $msg, route('user.ticket.view', $ticket->ticket));
            ...
            $this->adminFirebasePushNotification('ADMIN_NOTIFY_SUPPORT_TICKET_CLOSED', $msg, route('admin.ticket.view',$ticket->id));
            $this->userFirebasePushNotification($ticket->user, 'USER_NOTIFY_ADMIN_TICKET_CLOSED', $msg, route('user.ticket.view', $ticket->ticket));
