...
class PayoutRecordController extends Controller
{
    ...
    public function payoutCancel(Request $request, $id)
    {
        ...
        try {
            ...
            $this->adminFirebasePushNotification('ADMIN_NOTIFY_PAYOUT_REJECTED', $adminMsg, route('admin.payout-log'));
            $this->userFirebasePushNotification($user, 'USER_NOTIFY_PAYOUT_REJECTED', $userMsg);
    ...
    public function userSuccessNotify($data)
    {
        ...
        try {
            ...
            $this->adminFirebasePushNotification('ADMIN_NOTIFY_PAYOUT_APPROVE', $adminMsg, route('admin.payout-log'));
            $this->userFirebasePushNotification($user, 'USER_NOTIFY_PAYOUT_APPROVE', $userMsg);
