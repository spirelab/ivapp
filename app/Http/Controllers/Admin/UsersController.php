...
class UsersController extends Controller
{
    ...
    public function userUpdate(Request $request, $id)
    {
        ...
        $this->adminFirebasePushNotification('ADMIN_NOTIFY_WHEN_ADMIN_USER_UPDATE', $msg, route('admin.user-edit', $user->id));
        $this->userFirebasePushNotification($user, 'USER_NOTIFY_WHEN_ADMIN_PROFILE_UPDATE', $msg, route('user.profile'));
    ...
    public function badgeUpdate(Request $request, $id)
    {
        ...
        $this->adminFirebasePushNotification('BADGE_NOTIFY_TO_USRE', $msg, route('admin.users'));
        $this->userFirebasePushNotification($user, 'BADGE_NOTIFY_TO_ADMIN', $msg, route('user.profile'));
    ...
    public function kycAction(Request $request, $id)
    {
        ...
        if ($request->status == '1') {
            ...
            $this->adminFirebasePushNotification('ADMIN_NOTIFY_KYC_APPROVED', $adminMsg, route('admin.kyc.users'));
            $this->userFirebasePushNotification($user, 'USER_NOTIFY_KYC_APPROVED', $userMsg);
            ...
            $this->adminFirebasePushNotification('ADMIN_NOTIFY_KYC_REJECTED', $adminMsg, route('admin.kyc.users'));
            $this->userFirebasePushNotification($user, 'USER_NOTIFY_KYC_REJECTED', $userMsg);
