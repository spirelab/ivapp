        ...
        if ($user) {
            ...
            if ($badges) {
                ...
                if (isset($userBadge) && ($user->last_lavel == NULL ||  $userBadge->rank_lavel != $user->last_lavel) ) {
                    ...
                    $user->adminFirebasePushNotification($user, 'BADGE_NOTIFY_TO_USER', $msg);
                    $user->userFirebasePushNotification('BADGE_NOTIFY_TO_ADMIN', $msg);
