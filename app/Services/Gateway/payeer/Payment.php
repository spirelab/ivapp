...
class Payment
{
    public static function prepareData($order, $gateway, $mobile = false)
    {
        $basic = (object)config('basic');
        $m_amount = number_format($order->final_amount, 2, '.', "");
        $arHash = [
        ...
        $val['m_amount'] = round($order->final_amount, 2);
        ...
        $send['val'] = $val;
        $send['view'] = $mobile ? 'mobile-payment.redirect' : 'user.payment.redirect';
        $send['method'] = 'get';
