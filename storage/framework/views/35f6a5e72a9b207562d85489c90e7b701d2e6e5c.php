            ...
            <ul id="sidebarnav">
                ...
                <?php if(adminAccessRoute(array_merge(config('role.website_controls.access.view'), config('role.language_settings.access.view')))): ?>
                    ...
                    <?php if(adminAccessRoute(config('role.website_controls.access.view'))): ?>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.app.setting')); ?>" aria-expanded="false">
                                <i class="fas fa-tools text-danger"></i>
                                <span class="hide-menu"><?php echo app('translator')->get('App Settings'); ?></span>
                            </a>
                        </li>
                ...
                <?php endif; ?>
                <li class="list-divider"></li>
                <li class="nav-small-cap"><span class="hide-menu text-dark">Version 7.0.1</span></li>
...
<?php /**PATH /www/wwwroot/invest.xtake.com/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>