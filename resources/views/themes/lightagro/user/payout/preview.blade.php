            ...
            <div class="row profile-setting">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-type-1 bg-light">
                        <div class="card-header custom-header text-center borderBottom bg-white">
                        ...
                        <div class="card-body edit-area">
                            ...
                            <form action="" method="post" enctype="multipart/form-data"
                                ...
                                @if($payoutMethod->supported_currency)
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            <div class="form-group input-box search-currency-dropdown input-box">
                                    ...
                                    @foreach($withdraw->method->input_form as $k => $v)
                                        @if($v->type == "text")
                                            <div class="col-md-12 mb-3">
                                                <div class="form-group mt-2 input-box">
                                                    <label
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn-custom strpe___btn">
                                        @lang('Confirm Now')
                                    </button>
                                </div>
                            </form>
