                    ...
                    <form action="{{route('user.payout.moneyRequest')}}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="payment-form">
                                ...
                                <div class="form-group mb-30 mt-3 input-box">
                                    <div class="box">
                                        <h5 class="darkblue-text-bold">@lang('Select Walet')</h5>
                                        <select class="form-control" name="wallet_type">
                                            <option
                                                value="balance" class="bg-light text-dark">@lang('Deposit Balance - '.$basic->currency_symbol.getAmount(auth()->user()->balance))</option>
                                            <option value="interest_balance" class="bg-light text-dark">@lang('Interest Balance -'.$basic->currency_symbol.getAmount(auth()->user()->interest_balance))</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary btn-custom-rounded">@lang('Next')</button>
                        </div>
                    </form>
                </div>
            </div>
