                ...
                @foreach($gateways as $key => $gateway)
                    <div class="col-xl-2 col-md-6">
                        <div class="dashboard-box p-3">
                            <img class="img-fluid gateway" src="{{ getFile(config('location.gateway.path').$gateway->image)}}"
                                alt="{{$gateway->name}}">
                            <button
                                    data-id="{{$gateway->id}}"
                    ...
                    var htmlData = `
                     <ul class="list-group text-center">
                        ...
                        <li class="list-group-item mt-2">
                            <a href="${data.payment_url}" class="btn add__fund__pay__now__btn addFund pt-2">@lang('Pay Now')</a>
                        </li>
                        </ul>`;
