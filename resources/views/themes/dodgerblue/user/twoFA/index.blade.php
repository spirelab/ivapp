...
@section('content')
                                    ...
                                    <div class="box refferal-link">
                                        <div class="input-group">
                                            <input
                                                ...
                                                readonly
                                            />
                                            <button class="gold-btn copytext btn-custom" id="copyBoard" onclick="copyFunction()"><i class="fa fa-copy me-1"></i>@lang('copy code')</button>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 mb-3">
                            <div class="card text-center bg-light py-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mx-auto text-center">
                                        <a href="javascript:void(0)" class="btn btn-bg btn-lg btn-primary text-white"
                    ...
                    <div class="col-lg-6 col-md-6 mb-3">
                        <div class="card text-center bg-light py-2">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn btn-bg btn-md mt-3 btn-primary text-white"
    ...
    <!--Enable Modal -->
    <div id="enableModal" class="modal fade" role="dialog" tabindex="-1" aria-labelledby="addListingmodal" aria-hidden="true" data-bs-backdrop="static">
    ...
    <!--Disable Modal -->
    <div id="disableModal" class="modal fade" role="dialog" tabindex="-1" aria-labelledby="addListingmodal" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content form-block">
                <div class="modal-header modal-header-custom">
