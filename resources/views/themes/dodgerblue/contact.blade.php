            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="header-text">
                        ...
                        <h3>@lang(wordSplice($contact->heading)['withoutLastWord']) <span
                                class="text-stroke">@lang(wordSplice($contact->heading)['lastWord'])</span></h3>
                        <p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="info-box">
                                <div class="icon"><img src="{{ asset($themeTrue.'img/icon/location.png') }}" alt="">
                                </div>
                                <div class="text">
                                    <h4>@lang('Location')</h4>
