...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset($themeTrue.'assets/plugins/owlcarousel/owl.carousel.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset($themeTrue.'assets/plugins/owlcarousel/owl.theme.default.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset($themeTrue.'assets/plugins/aos/aos.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset($themeTrue.'assets/plugins/radial-progress/radialprogress.css')}}">
                            ...
                            <ul class="notification-dropdown user-dropdown">
                                <li>
                                    <a class="dropdown-item" href="{{route('user.home')}}">
                                        <img src="{{asset($themeTrue.'img/icon/layout.png')}}"
                                             alt="@lang('Dashboard')"/>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('user.profile') }}">
                                        <img src="{{asset($themeTrue.'img/icon/profile.png')}}"
                                             alt="@lang('My Profile')"/>
...
<script src="{{asset($themeTrue.'assets/plugins/radial-progress/radialprogressOld.js')}}"></script>
