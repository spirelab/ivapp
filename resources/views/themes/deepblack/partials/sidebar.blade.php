<div id="sidebar">
    ...
    <div class="sidebar-top">
        <a class="navbar-brand d-none d-lg-block" href="{{route('home')}}"> <img src="{{getFile(config('location.logoIcon.path').'logo.png')}}" alt="@lang('brand logo')" /></a>
       ...
       <li class="{{menuActive(['user.profile'])}}">
        ...
        <li class="d-lg-none">
            <a href="{{route('user.twostep.security')}}">
                <img src="{{asset($themeTrue.'img/icon/padlock.png')}}" alt="2FA Security"> @lang('2FA Security')
            </a>
        </li>
