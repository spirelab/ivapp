...
Route::get('payment/view/{fund_id}', 'Api\V1\PaymentController@paymentView')->name('paymentView');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin', 'permission']], function () {
        ...
        Route::any('/app-setting', 'Admin\BasicController@appSetting')->name('app.setting');
